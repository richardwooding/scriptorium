...
(function () {
  ...
  function buildSystem() {
    ...
    return [
      ...
      "build it. Immediately call write_files to create the whole project at once",
      "(e.g. go.mod, main.go, any frontend/HTML/JS, a README with run instructions),",
      "then reply with just a 1–3 sentence summary of what you created.",
      ...
      "human paths like \"src/main.go\". Edits apply IMMEDIATELY and are seen live by",
